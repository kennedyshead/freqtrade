...
def test_parse_timerange_incorrect():
    ...
    assert TimeRange("date", None, 1274486400, 0) == TimeRange.parse_timerange(
        "20100522-"
    )
    assert TimeRange(None, "date", 0, 1274486400) == TimeRange.parse_timerange(
        "-20100522"
    )
    ...
    assert TimeRange("date", None, 1231006505, 0) == TimeRange.parse_timerange(
        "1231006505-"
    )
    assert TimeRange(None, "date", 0, 1233360000) == TimeRange.parse_timerange(
        "-1233360000"
    )
